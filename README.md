...
> Levchenko, E., Chow-Wing-Bom, H., Dick, F., Cooper, G., Tierney, A. & Skipper, J. I. A neuroimaging dataset combining movie-watching, eye-tracking, sensorimotor mapping, and cognitive tasks. *Scientific Data* 13, 1184 (2026). https://doi.org/10.1038/s41597-026-07676-4

You can also support the project by starring this repository on GitHub ⭐ and on [OpenNeuro](https://openneuro.org/datasets/ds006642/versions/1.1.1) 🧠. It helps others discover the resource and is a great way to show your support!
