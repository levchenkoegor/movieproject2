...
task_name = 'tonotopy'
output_per_subject_csv = base_dir / "bids_data/derivatives/group_analysis/tonotopy" / f"{task_name}_per_subject_motion.csv"
output_mean_csv = base_dir / "bids_data/derivatives/group_analysis/tonotopy" / f"{task_name}_mean_motion.csv"
...
TRs_per_run = 256  # Each run has exactly 256 TRs
...
def load_and_slice_motion_params(subject_id):
    ...
    # Ensure the total number of TRs is enough for 2 runs
    total_TRs = TRs_per_run * 2
