...
pattern = os.path.join(root_path, 'sub-*', 'tonotopy', 'sub-*.results*', '*.dat.mincost')
...
# Save to CSV
filename = 'tonotopy_mincost_per_sub.csv'
df.to_csv(f'/egor2/egor/MovieProject2/analysis/tonotopy/{filename}', index=False)
